...
//                                            "}]};
                            ...
                            //var newData = {"totalRecords": rows,"curPage":1,"data": newRowJson};
                            //var newRow = $("#example").jqxGrid('addrow', rows, newData);
                            //$('#example').jqxGrid('selectrow', newData.uid);
                            $.ajax({
            ...
            $('#addButton').on('click',
                    ...
                    function(){
                        ...
                        //$("#dialog-form").jqxWindow({height: 90, width: 150});
                        //$("#btnOK").jqxButton({ width: '150', height: '25'});
            ...
            $("#example").jqxGrid(
                    {
                        ...
                        columns: [
                            ...
                            { text: 'Full Name', datafield: 'fullName', width: 100 },
