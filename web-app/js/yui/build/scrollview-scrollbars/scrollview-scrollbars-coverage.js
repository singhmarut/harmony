...
lastChild.setStyle(dimOffset, lastChildPosition + PX);
    ...
    _update: function(x, y, duration) {
        _yuitest_coverfunc("build/scrollview-scrollbars/scrollview-scrollbars.js", "_update", 432);
...
if (axis && axis.y && vNode && y !== null) {
            _yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 445);
...
if (axis && axis.x && hNode && x !== null) {
            _yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 449);
this._updateBar(hNode, x, duration, true);
    ...
    show: function(animated) {
        _yuitest_coverfunc("build/scrollview-scrollbars/scrollview-scrollbars.js", "show", 459);
_yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 460);
this._show(true, animated);
    ...
    hide: function(animated) {
        _yuitest_coverfunc("build/scrollview-scrollbars/scrollview-scrollbars.js", "hide", 469);
_yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 470);
this._show(false, animated);
    ...
    _show : function(show, animated) {
        ...
        _yuitest_coverfunc("build/scrollview-scrollbars/scrollview-scrollbars.js", "_show", 481);
...
if (verticalNode) {
            _yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 503);
verticalNode.transition(transition);
        }

        _yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 506);
if (horizontalNode) {
            _yuitest_coverline("build/scrollview-scrollbars/scrollview-scrollbars.js", 507);
horizontalNode.transition(transition);
     ...
     */
    flash: function() {
        _yuitest_coverfunc("build/scrollview-scrollbars/scrollview-scrollbars.js", "flash", 516);
...
}, '3.8.1', {"requires": ["classnamemanager", "transition", "plugin"], "skinnable": true});
