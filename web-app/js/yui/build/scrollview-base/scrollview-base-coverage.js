...
var getClassName = Y.ClassNameManager.getClassName,
    ...
    _constrain = function (val, min, max) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_constrain", 48);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 49);
 ...
 * @constructor
 */
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 61);
function ScrollView() {
    _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "ScrollView", 61);
...
Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
    ...
    initializer: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "initializer", 131);
...
sv._cFrameDuration = sv.get(FRAME_DURATION);
     ...
     */
    bindUI: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "bindUI", 152);
...
sv.set(BOUNCE_RANGE, ScrollView.BOUNCE_RANGE);
     ...
     */
    _bindAttrs: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_bindAttrs", 200);
...
sv._bindDrag(sv.get(DRAG));
    ...
    _bindMousewheel: function (mousewheel) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_bindMousewheel", 271);
...
Y.one(DOCUMENT).on(MOUSEWHEEL, Y.bind(sv._mousewheel, sv));
     ...
     */
    syncUI: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "syncUI", 293);
...
sv._snapBack();
    ...
    _getScrollDims: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_getScrollDims", 337);
...
sv._forceHWTransforms = origHWTransform;
        ...
        _yuitest_coverline("build/scrollview-base/scrollview-base.js", 370);
return dims;
    },
    ...
    _uiDimensionsChange: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_uiDimensionsChange", 380);
...
sv._maxScrollY = Math.max(0, scrollHeight - height);
    ...
    scrollTo: function (x, y, duration, easing, node) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "scrollTo", 447);
...
node.transition(transition, callback);
    ...
    _transform: function (x, y) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_transform", 527);
...
return prop;
    ...
    */
    _moveTo : function(node, x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_moveTo", 547);
...
node.setStyle(TOP, y + PX);
    ...
    _onTransEnd: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onTransEnd", 564);
...
sv.fire(EV_SCROLL_END);
    ...
    _onGestureMoveStart: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onGestureMoveStart", 583);
...
sv.set(axisAttr, newPosition);
    ...
    _mousewheel: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_mousewheel", 851);
...
sv._onTransEnd();
            ...
            _yuitest_coverline("build/scrollview-base/scrollview-base.js", 887);
e.preventDefault();
        }
    },
    ...
    _isOutOfBounds: function (x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_isOutOfBounds", 900);
...
return (svAxisX && (currentX < minX || currentX > maxX)) || (svAxisY && (currentY < minY || currentY > maxY));
     ...
     */
    _snapBack: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_snapBack", 922);
...
sv.set(SCROLL_X, newX, {duration:duration, easing:easing});
        ...
        else {_yuitest_coverline("build/scrollview-base/scrollview-base.js", 938);
if (newY !== currentY) {
...
sv._onTransEnd();
    ...
    _afterScrollChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollChange", 954);
...
sv.scrollTo.apply(sv, scrollToArgs);
    ...
    _afterFlickChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterFlickChange", 992);
...
this._bindFlick(e.newVal);
    ...
    _afterDisabledChange: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDisabledChange", 1003);
...
this._cDisabled = e.newVal;
    ...
    _afterAxisChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterAxisChange", 1015);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1016);
this._cAxis = e.newVal;
    ...
    _afterDragChange: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDragChange", 1026);
...
this._bindDrag(e.newVal);
    ...
    _afterDimChange: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterDimChange", 1037);
...
this._uiDimensionsChange();
    ...
    _afterScrollEnd: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_afterScrollEnd", 1048);
...
sv._snapBack();
    ...
    _axisSetter: function (val) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_axisSetter", 1080);
...
return {
    ...
    */
    _setScroll : function(val) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScroll", 1101);
...
return val;
    ...
    */
    _setScrollX: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollX", 1119);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1120);
return this._setScroll(val, DIM_X);
    ...
    */
    _setScrollY: function(val) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_setScrollY", 1131);
_yuitest_coverline("build/scrollview-base/scrollview-base.js", 1132);
...
}, '3.8.1', {"requires": ["widget", "event-gestures", "event-mousewheel", "transition"], "skinnable": true});
