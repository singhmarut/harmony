...
_yuitest_coverline("build/template-micro/template-micro.js", 27);
...
@since 3.8.0
**/
_yuitest_coverline("build/template-micro/template-micro.js", 50);
Micro.options = {
    code         : /<%([\s\S]+?)%>/g,
    escapedOutput: /<%=([\s\S]+?)%>/g,
    rawOutput    : /<%==([\s\S]+?)%>/g,
...
@since 3.8.0
**/
_yuitest_coverline("build/template-micro/template-micro.js", 117);
Micro.compile = function (text, options) {
    /*jshint evil:true */

    _yuitest_coverfunc("build/template-micro/template-micro.js", "compile", 117);
_yuitest_coverline("build/template-micro/template-micro.js", 120);
var blocks     = [],
        tokenClose = "\uffff",
        tokenOpen  = "\ufffe",
        source;

    _yuitest_coverline("build/template-micro/template-micro.js", 125);
...
source = "var $b='', $v=function (v){return v || v === 0 ? v : $b;}, $t='" +
        ...
        .replace(options.rawOutput, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 2)", 148);
_yuitest_coverline("build/template-micro/template-micro.js", 149);
return tokenOpen + (blocks.push("'+\n$v(" + code + ")+\n'") - 1) + tokenClose;
        })

        .replace(options.escapedOutput, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 3)", 152);
_yuitest_coverline("build/template-micro/template-micro.js", 153);
return tokenOpen + (blocks.push("'+\n$e($v(" + code + "))+\n'") - 1) + tokenClose;
        })

        .replace(options.code, function (match, code) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 4)", 156);
_yuitest_coverline("build/template-micro/template-micro.js", 157);
return tokenOpen + (blocks.push("';\n" + code + "\n$t+='") - 1) + tokenClose;
        })

        .replace(options.stringEscape, function (match) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 5)", 160);
_yuitest_coverline("build/template-micro/template-micro.js", 161);
return options.stringReplace[match] || '';
        })

        // Replace the token placeholders with code.
        .replace(/\ufffe(\d+)\uffff/g, function (match, index) {
            _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 6)", 165);
_yuitest_coverline("build/template-micro/template-micro.js", 166);
...
if (options.precompile) {
        _yuitest_coverline("build/template-micro/template-micro.js", 176);
return "function (Y, $e, data) {\n" + source + "\n}";
    }

    // Otherwise, return an executable function.
    _yuitest_coverline("build/template-micro/template-micro.js", 180);
...
@since 3.8.0
**/
_yuitest_coverline("build/template-micro/template-micro.js", 201);
Micro.precompile = function (text, options) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "precompile", 201);
_yuitest_coverline("build/template-micro/template-micro.js", 202);
options || (options = {});
    _yuitest_coverline("build/template-micro/template-micro.js", 203);
options.precompile = true;

    _yuitest_coverline("build/template-micro/template-micro.js", 205);
...
@since 3.8.0
**/
_yuitest_coverline("build/template-micro/template-micro.js", 225);
Micro.render = function (text, data, options) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "render", 225);
_yuitest_coverline("build/template-micro/template-micro.js", 226);
...
@since 3.8.0
**/
_yuitest_coverline("build/template-micro/template-micro.js", 241);
Micro.revive = function (precompiled) {
    _yuitest_coverfunc("build/template-micro/template-micro.js", "revive", 241);
_yuitest_coverline("build/template-micro/template-micro.js", 242);
return function (data) {
        _yuitest_coverfunc("build/template-micro/template-micro.js", "(anonymous 7)", 242);
_yuitest_coverline("build/template-micro/template-micro.js", 243);
data || (data = {});
        _yuitest_coverline("build/template-micro/template-micro.js", 244);
return precompiled.call(data, Y, Y.Escape.html, data);
    };
};


}, '3.8.1', {"requires": ["escape"]});
