...
return val;
        ...
        width: {
            getter: function()
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "getter", 1487);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1489);
var chart = this.get("chart"),
                    parentNode = this._parentNode;
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1491);
if(parentNode)
                {
                    _yuitest_coverline("build/charts-legend/charts-legend.js", 1493);
if((chart && this.get("includeInChartLayout")) || this._width)
                    {
                        _yuitest_coverline("build/charts-legend/charts-legend.js", 1495);
if(!this._width)
                        {
                            _yuitest_coverline("build/charts-legend/charts-legend.js", 1497);
this._width = 0;
                        }
                        _yuitest_coverline("build/charts-legend/charts-legend.js", 1499);
return this._width;
                    }
                    else
                    {
...
return parentNode.get("offsetWidth");
                ...
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1506);
return "";
            },

            setter: function(val)
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "setter", 1509);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1511);
this._width = val;
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1512);
return val;
            }
        },
        ...
        height: {
            ...
            getter: function()
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "getter", 1531);
...
if((chart && this.get("includeInChartLayout")) || this._height)
                    {
                        _yuitest_coverline("build/charts-legend/charts-legend.js", 1539);
if(!this._height)
                        {
                            _yuitest_coverline("build/charts-legend/charts-legend.js", 1541);
this._height = 0;
                        }
                        _yuitest_coverline("build/charts-legend/charts-legend.js", 1543);
return this._height;
                    }
                    else
                    {
...
return "";
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "setter", 1553);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1555);
this._height = val;
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1556);
return val;
            }
        },
        ...
        x: {
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "setter", 1572);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1574);
var node = this.get("boundingBox");
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1575);
if(node)
                {
                    _yuitest_coverline("build/charts-legend/charts-legend.js", 1577);
node.setStyle(LEFT, val + PX);
                }
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1579);
return val;
            }
        },
        ...
        y: {
            ...
            setter: function(val)
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "setter", 1595);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1597);
var node = this.get("boundingBox");
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1598);
if(node)
                {
                    _yuitest_coverline("build/charts-legend/charts-legend.js", 1600);
node.setStyle(TOP, val + PX);
                }
                _yuitest_coverline("build/charts-legend/charts-legend.js", 1602);
return val;
            }
        },
        ...
        items: {
            getter: function()
            {
                _yuitest_coverfunc("build/charts-legend/charts-legend.js", "getter", 1619);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1621);
return this._items;
            }
        },
 ...
 * @constructor
 */
_yuitest_coverline("build/charts-legend/charts-legend.js", 1693);
function Chart(cfg)
{
    _yuitest_coverfunc("build/charts-legend/charts-legend.js", "Chart", 1693);
_yuitest_coverline("build/charts-legend/charts-legend.js", 1695);
if(cfg.type != "pie")
    {
        _yuitest_coverline("build/charts-legend/charts-legend.js", 1697);
return new Y.CartesianChart(cfg);
    }
    else
    {
        _yuitest_coverline("build/charts-legend/charts-legend.js", 1701);
return new Y.PieChart(cfg);
    }
}
_yuitest_coverline("build/charts-legend/charts-legend.js", 1704);
Y.Chart = Chart;
