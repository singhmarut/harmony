...
docEl.insertBefore(YUI.Env.cssStampEl, docEl.firstChild);
        ...
        } else {_yuitest_coverline("build/yui/yui.js", 485);
if (doc && doc.getElementById(CSS_STAMP_EL) && !YUI.Env.cssStampEl) {
            _yuitest_coverline("build/yui/yui.js", 486);
...
Y.config.base = YUI.config.base || Y.Env.getBase(Y.Env._BASE_RE);
        ...
        _yuitest_coverline("build/yui/yui.js", 493);
...
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
    ...
    **/
    _setup: function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "_setup", 508);
...
core.push(extras[i]);
        ...
        _yuitest_coverline("build/yui/yui.js", 520);
Y._attach(['yui-base']);
        _yuitest_coverline("build/yui/yui.js", 521);
Y._attach(core);

        _yuitest_coverline("build/yui/yui.js", 523);
if (Y.Loader) {
...
getLoader(Y);
    ...
    **/
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui/yui.js", "applyTo", 541);
...
this.log('applyTo not found: ' + method, 'warn', 'yui');
            ...
            _yuitest_coverline("build/yui/yui.js", 557);
return m && m.apply(instance, args);
        }

        _yuitest_coverline("build/yui/yui.js", 560);
return null;
    },
...
**/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui/yui.js", "add", 610);
_yuitest_coverline("build/yui/yui.js", 611);
details = details || {};
...
return this;
    ...
    **/
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui/yui.js", "_attach", 656);
...
return false;
                                ...
                                _yuitest_coverline("build/yui/yui.js", 766);
break;
                            }
                        }
                    }
...
mod.fn(Y, name);
                                ...
                                _yuitest_coverline("build/yui/yui.js", 775);
try {
                                    _yuitest_coverline("build/yui/yui.js", 776);
mod.fn(Y, name);
                                } catch (e) {
                                    _yuitest_coverline("build/yui/yui.js", 778);
...
return false;
                                ...
                                _yuitest_coverline("build/yui/yui.js", 790);
break;
                            }
                        }
                    }
        ...
        _yuitest_coverline("build/yui/yui.js", 801);
return true;
    },
    ...
    **/
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_delayCallback", 815);
_yuitest_coverline("build/yui/yui.js", 817);
var Y = this,
            mod = ['event-base'];
...
until = (Y.Lang.isObject(until) ? until : { event: until });
        ...
        _yuitest_coverline("build/yui/yui.js", 822);
if (until.event === 'load') {
...
return function() {
            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 3)", 826);
_yuitest_coverline("build/yui/yui.js", 827);
var args = arguments;
            _yuitest_coverline("build/yui/yui.js", 828);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 4)", 828);
_yuitest_coverline("build/yui/yui.js", 829);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 5)", 829);
...
cb.apply(Y, args);
    ...
    **/
    use: function() {
        _yuitest_coverfunc("build/yui/yui.js", "use", 900);
_yuitest_coverline("build/yui/yui.js", 901);
...
@since 3.6.0
**/
_yuitest_coverline("build/yui/yui.js", 1711);
...
_yuitest_coverfunc("build/yui/yui.js", "(anonymous 8)", 1711);
_yuitest_coverline("build/yui/yui.js", 1733);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 1781);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui/yui.js", "_isNative", 1781);
_yuitest_coverline("build/yui/yui.js", 1782);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 1799);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui/yui.js", "isArray", 1799);
_yuitest_coverline("build/yui/yui.js", 1800);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1810);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isBoolean", 1810);
_yuitest_coverline("build/yui/yui.js", 1811);
...
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isDate", 1821);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1849);
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isFunction", 1849);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1860);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNull", 1860);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1871);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNumber", 1871);
_yuitest_coverline("build/yui/yui.js", 1872);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui/yui.js", "isObject", 1886);
_yuitest_coverline("build/yui/yui.js", 1887);
var t = typeof o;
    _yuitest_coverline("build/yui/yui.js", 1888);
return (o && (t === 'object' ||
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1899);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isString", 1899);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1910);
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isUndefined", 1910);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1923);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isValue", 1923);
...
return isFinite(o);
        ...
        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("build/yui/yui.js", 1932);
return false;

        default:
            _yuitest_coverline("build/yui/yui.js", 1935);
return !!t;
    }
};
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui/yui.js", 1947);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 9)", 1947);
_yuitest_coverline("build/yui/yui.js", 1948);
...
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui/yui.js", "sub", 1962);
_yuitest_coverline("build/yui/yui.js", 1963);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 10)", 1963);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1976);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 11)", 1976);
_yuitest_coverline("build/yui/yui.js", 1977);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 1978);
_yuitest_coverline("build/yui/yui.js", 1979);
try {
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 1993);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 12)", 1993);
_yuitest_coverline("build/yui/yui.js", 1994);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 1995);
_yuitest_coverline("build/yui/yui.js", 1996);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2006);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 13)", 2006);
_yuitest_coverline("build/yui/yui.js", 2007);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2008);
_yuitest_coverline("build/yui/yui.js", 2009);
return s.replace(/\s+$/, '');
};
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "type", 2039);
_yuitest_coverline("build/yui/yui.js", 2040);
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui/yui.js", "YArray", 2080);
...
result = [];
            ...
            _yuitest_coverline("build/yui/yui.js", 2092);
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui/yui.js", 2093);
result.push(thing[startIndex]);
            }

            _yuitest_coverline("build/yui/yui.js", 2096);
return result;
        }
    }
...
_yuitest_coverline("build/yui/yui.js", 2103);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("build/yui/yui.js", 2119);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui/yui.js", "dedupe", 2119);
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 14)", 2151);
_yuitest_coverline("build/yui/yui.js", 2152);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui/yui.js", 2153);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2154);
_yuitest_coverline("build/yui/yui.js", 2155);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2156);
if (i in array) {
            _yuitest_coverline("build/yui/yui.js", 2157);
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2188);
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui/yui.js", "hash", 2188);
_yuitest_coverline("build/yui/yui.js", 2189);
var hash = {},
...
if (i in keys) {
            _yuitest_coverline("build/yui/yui.js", 2195);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2199);
return hash;
};
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 15)", 2216);
_yuitest_coverline("build/yui/yui.js", 2217);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui/yui.js", "}", 2218);
_yuitest_coverline("build/yui/yui.js", 2220);
var len = array.length;

    _yuitest_coverline("build/yui/yui.js", 2222);
from = +from || 0;
...
return from;
    ...
    _yuitest_coverline("build/yui/yui.js", 2239);
return -1;
};
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "numericSort", 2261);
_yuitest_coverline("build/yui/yui.js", 2262);
return a - b;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2281);
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 16)", 2281);
_yuitest_coverline("build/yui/yui.js", 2282);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2283);
_yuitest_coverline("build/yui/yui.js", 2284);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2285);
...
return true;
    ...
    _yuitest_coverline("build/yui/yui.js", 2290);
return false;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2311);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "test", 2311);
_yuitest_coverline("build/yui/yui.js", 2312);
var result = 0;

    _yuitest_coverline("build/yui/yui.js", 2314);
if (Lang.isArray(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2315);
result = 1;
    } else {_yuitest_coverline("build/yui/yui.js", 2316);
if (Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2317);
try {
            // indexed, but no tagName (element) or scrollTo/document (window. From DOM.isWindow test which we can't use here),
            // or functions without apply/call (Safari
            // HTMLElementCollection bug).
            _yuitest_coverline("build/yui/yui.js", 2321);
...
function Queue() {
    _yuitest_coverfunc("build/yui/yui.js", "Queue", 2345);
_yuitest_coverline("build/yui/yui.js", 2346);
this._init();
    _yuitest_coverline("build/yui/yui.js", 2347);
this.add.apply(this, arguments);
}

_yuitest_coverline("build/yui/yui.js", 2350);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui/yui.js", "_init", 2357);
_yuitest_coverline("build/yui/yui.js", 2365);
this._q = [];
    },
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui/yui.js", "next", 2374);
_yuitest_coverline("build/yui/yui.js", 2375);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui/yui.js", "last", 2384);
_yuitest_coverline("build/yui/yui.js", 2385);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui/yui.js", "add", 2395);
_yuitest_coverline("build/yui/yui.js", 2396);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui/yui.js", 2398);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui/yui.js", "size", 2407);
_yuitest_coverline("build/yui/yui.js", 2408);
...
_yuitest_coverline("build/yui/yui.js", 2414);
...
_yuitest_coverline("build/yui/yui.js", 2425);
...
@for YUI
**/
_yuitest_coverline("build/yui/yui.js", 2454);
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui/yui.js", "cached", 2454);
_yuitest_coverline("build/yui/yui.js", 2455);
cache || (cache = {});

    _yuitest_coverline("build/yui/yui.js", 2457);
return function (arg) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 17)", 2457);
_yuitest_coverline("build/yui/yui.js", 2458);
...
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui/yui.js", 2463);
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 2486);
Y.getLocation = function () {
    // It is safer to look this up every time because yui-base is attached to a
    // YUI instance before a user's config is applied; i.e. `Y.config.win` does
    // not point the correct window object when this file is loaded.
    _yuitest_coverfunc("build/yui/yui.js", "getLocation", 2486);
_yuitest_coverline("build/yui/yui.js", 2490);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui/yui.js", 2496);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui/yui.js", "merge", 2511);
_yuitest_coverline("build/yui/yui.js", 2512);
var i      = 0,
    ...
    _yuitest_coverline("build/yui/yui.js", 2518);
for (; i < len; ++i) {
...
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 2522);
...
result[key] = obj[key];
    ...
    _yuitest_coverline("build/yui/yui.js", 2528);
return result;
};
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 2565);
...
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui/yui.js", 2572);
return receiver || Y;
    }

    _yuitest_coverline("build/yui/yui.js", 2575);
if (mode) {
        // In mode 2 (prototype to prototype and object to object), we recurse
        // once to do the proto to proto mix. The object to object mix will be
        // handled later on.
        _yuitest_coverline("build/yui/yui.js", 2579);
if (mode === 2) {
            _yuitest_coverline("build/yui/yui.js", 2580);
...
from = mode === 1 || mode === 3 ? supplier.prototype : supplier;
        _yuitest_coverline("build/yui/yui.js", 2587);
to   = mode === 1 || mode === 4 ? receiver.prototype : receiver;

        // If either the supplier or receiver doesn't actually have a
        // prototype property, then we could end up with an undefined `from`
        // or `to`. If that happens, we abort and return the receiver.
        _yuitest_coverline("build/yui/yui.js", 2592);
if (!from || !to) {
            _yuitest_coverline("build/yui/yui.js", 2593);
return receiver;
        }
    } else {
        _yuitest_coverline("build/yui/yui.js", 2596);
from = supplier;
        _yuitest_coverline("build/yui/yui.js", 2597);
to   = receiver;
    }
...
if (whitelist) {
        _yuitest_coverline("build/yui/yui.js", 2605);
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 2606);
key = whitelist[i];
            ...
            // method.
            _yuitest_coverline("build/yui/yui.js", 2613);
...
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui/yui.js", 2632);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2633);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        _yuitest_coverline("build/yui/yui.js", 2641);
for (key in from) {
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2659);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui/yui.js", 2660);
to[key] = from[key];
            }}
        }
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui/yui.js", 2667);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui/yui.js", 2668);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2672);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
_yuitest_coverline("build/yui/yui.js", 2688);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 18)", 2704);
_yuitest_coverline("build/yui/yui.js", 2710);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 19)", 2711);
_yuitest_coverline("build/yui/yui.js", 2713);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui/yui.js", 2716);
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 20)", 2716);
_yuitest_coverline("build/yui/yui.js", 2717);
F.prototype = obj;
        _yuitest_coverline("build/yui/yui.js", 2718);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 2779);
_yuitest_coverline("build/yui/yui.js", 2780);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2792);
O.hasKey = owns;
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 2815);
_yuitest_coverline("build/yui/yui.js", 2816);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2817);
...
keys.push(key);
    ...
    _yuitest_coverline("build/yui/yui.js", 2847);
return keys;
};
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 2867);
...
values.push(obj[keys[i]]);
    ...
    _yuitest_coverline("build/yui/yui.js", 2877);
return values;
};
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 2888);
_yuitest_coverline("build/yui/yui.js", 2889);
try {
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 2906);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2930);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 2930);
_yuitest_coverline("build/yui/yui.js", 2931);
var key;

    _yuitest_coverline("build/yui/yui.js", 2933);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 2934);
...
fn.call(thisObj || Y, obj[key], key, obj);
    ...
    _yuitest_coverline("build/yui/yui.js", 2939);
return Y;
};
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 2962);
...
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui/yui.js", 2968);
return true;
            }
        }
    }
...
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 2989);
_yuitest_coverline("build/yui/yui.js", 2990);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui/yui.js", 2991);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui/yui.js", 2994);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui/yui.js", 2998);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui/yui.js", 2999);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui/yui.js", 3002);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 3019);
_yuitest_coverline("build/yui/yui.js", 3020);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;
...
if (leafIdx >= 0) {
        _yuitest_coverline("build/yui/yui.js", 3026);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui/yui.js", 3027);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui/yui.js", 3030);
if (ref !== UNDEFINED) {
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 3049);
_yuitest_coverline("build/yui/yui.js", 3050);
...
YUI.Env.parseUA = function(subUA) {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 3085);
_yuitest_coverline("build/yui/yui.js", 3087);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 3087);
_yuitest_coverline("build/yui/yui.js", 3088);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 3089);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 22)", 3089);
...
if (ua) {
        ...
        _yuitest_coverline("build/yui/yui.js", 3331);
...
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 3341);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3342);
o.os = 'rhino';
        }}}}}}

        // Modern KHTML browsers should qualify as Safari X-Grade
        _yuitest_coverline("build/yui/yui.js", 3346);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3347);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui/yui.js", 3349);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3350);
o.mobile = 'windows';
        }
        _yuitest_coverline("build/yui/yui.js", 3352);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3353);
o.mobile = 'gecko';
        }
...
if (m && m[1]) {
            _yuitest_coverline("build/yui/yui.js", 3358);
...
m = ua.match(/PhantomJS\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3363);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3364);
o.phantomjs = numberify(m[1]);
                }
            }

            // Mobile browser check
            _yuitest_coverline("build/yui/yui.js", 3369);
...
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3373);
if (m && m[1]) {
...
if (m && m[0]) {
                    _yuitest_coverline("build/yui/yui.js", 3382);
...
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3394);
o.webos = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui/yui.js", 3397);
if (/ Android/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3398);
if (/Mobile/.test(ua)) {
...
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3403);
...
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("build/yui/yui.js", 3409);
if (m && m[1]) {
...
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("build/yui/yui.js", 3426);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui/yui.js", 3427);
o.mobile = 'chrome';
                }
            } else {
...
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3432);
...
m = ua.match(/Opera Mini[^;]*/);
                ...
                _yuitest_coverline("build/yui/yui.js", 3458);
if (m) {
...
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui/yui.js", 3463);
if (m && m[1]) {
...
if (m && m[1]) {
                            _yuitest_coverline("build/yui/yui.js", 3471);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui/yui.js", 3481);
...
o.nodejs = numberify(process.versions.node);
        ...
        _yuitest_coverline("build/yui/yui.js", 3497);
YUI.Env.UA = o;
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui/yui.js", 3527);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 3527);
_yuitest_coverline("build/yui/yui.js", 3528);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui/yui.js", 3530);
if (a === b) {
        _yuitest_coverline("build/yui/yui.js", 3531);
return 0;
    }

    _yuitest_coverline("build/yui/yui.js", 3534);
aParts = (a + '').split('.');
...
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3538);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui/yui.js", 3539);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui/yui.js", 3541);
isNaN(aPart) && (aPart = 0);
...
if (aPart < bPart) {
            _yuitest_coverline("build/yui/yui.js", 3545);
return -1;
        }
...
_yuitest_coverline("build/yui/yui.js", 3555);
YUI.Env.aliases = {
