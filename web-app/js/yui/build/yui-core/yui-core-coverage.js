...
**/
    ...
    /*global YUI*/
    /*global YUI_config*/
    _yuitest_coverline("build/yui-core/yui-core.js", 58);
var YUI = function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "YUI", 58);
_yuitest_coverline("build/yui-core/yui-core.js", 59);
var i = 0,
            Y = this,
            args = arguments,
            l = args.length,
            instanceOf = function(o, type) {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "instanceOf", 63);
...
if (!(instanceOf(Y, YUI))) {
            _yuitest_coverline("build/yui-core/yui-core.js", 69);
Y = new YUI();
        } else {
            // set up the core environment
            _yuitest_coverline("build/yui-core/yui-core.js", 72);
Y._init();
            ...
            @static
            **/
            _yuitest_coverline("build/yui-core/yui-core.js", 99);
if (YUI.GlobalConfig) {
                _yuitest_coverline("build/yui-core/yui-core.js", 100);
Y.applyConfig(YUI.GlobalConfig);
            ...
            @global
            **/
            _yuitest_coverline("build/yui-core/yui-core.js", 128);
if (gconf) {
                _yuitest_coverline("build/yui-core/yui-core.js", 129);
Y.applyConfig(gconf);
            }

            // bind the specified additional modules for this instance
            _yuitest_coverline("build/yui-core/yui-core.js", 133);
if (!l) {
                _yuitest_coverline("build/yui-core/yui-core.js", 134);
Y._setup();
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 138);
if (l) {
            // Each instance can accept one or more configuration objects.
            // These are applied after YUI.GlobalConfig and YUI_Config,
            // overriding values set in those config files if there is a
            // matching property.
            _yuitest_coverline("build/yui-core/yui-core.js", 143);
for (; i < l; i++) {
                _yuitest_coverline("build/yui-core/yui-core.js", 144);
Y.applyConfig(args[i]);
            }

            _yuitest_coverline("build/yui-core/yui-core.js", 147);
Y._setup();
        }
...
Y.instanceOf = instanceOf;
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 152);
return Y;
    };
...
(function() {
    ...
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 1)", 155);
_yuitest_coverline("build/yui-core/yui-core.js", 157);
var proto, prop,
        VERSION = '3.8.1',
        PERIOD = '.',
        ...
        */
        ...
        add = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "add", 180);
_yuitest_coverline("build/yui-core/yui-core.js", 181);
if (el && el.addEventListener) {
                _yuitest_coverline("build/yui-core/yui-core.js", 182);
el.addEventListener(type, fn, capture);
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 183);
if (el && el.attachEvent) {
                _yuitest_coverline("build/yui-core/yui-core.js", 184);
el.attachEvent('on' + type, fn);
            }}
        },
        remove = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "remove", 187);
_yuitest_coverline("build/yui-core/yui-core.js", 188);
if (el && el.removeEventListener) {
                // this can throw an uncaught exception in FF
                _yuitest_coverline("build/yui-core/yui-core.js", 190);
try {
                    _yuitest_coverline("build/yui-core/yui-core.js", 191);
el.removeEventListener(type, fn, capture);
                } catch (ex) {}
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 193);
if (el && el.detachEvent) {
                _yuitest_coverline("build/yui-core/yui-core.js", 194);
el.detachEvent('on' + type, fn);
            }}
        },
        handleLoad = function() {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "handleLoad", 197);
_yuitest_coverline("build/yui-core/yui-core.js", 198);
YUI.Env.windowLoaded = true;
            _yuitest_coverline("build/yui-core/yui-core.js", 199);
YUI.Env.DOMReady = true;
            _yuitest_coverline("build/yui-core/yui-core.js", 200);
if (hasWin) {
                _yuitest_coverline("build/yui-core/yui-core.js", 201);
remove(window, 'load', handleLoad);
            }
        },
        getLoader = function(Y, o) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "getLoader", 204);
_yuitest_coverline("build/yui-core/yui-core.js", 205);
...
loader.data = null;
                _yuitest_coverline("build/yui-core/yui-core.js", 215);
loader.required = [];
                _yuitest_coverline("build/yui-core/yui-core.js", 216);
loader.loadType = null;
            } else {
                _yuitest_coverline("build/yui-core/yui-core.js", 218);
loader = new Y.Loader(Y.config);
                _yuitest_coverline("build/yui-core/yui-core.js", 219);
Y.Env._loader = loader;
            }
            _yuitest_coverline("build/yui-core/yui-core.js", 221);
if (mods && mods.loader) {
...
YUI.Env.core = Y.Array.dedupe([].concat(YUI.Env.core, lCore));
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 226);
return loader;
        },

        clobber = function(r, s) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "clobber", 229);
_yuitest_coverline("build/yui-core/yui-core.js", 230);
for (var i in s) {
                _yuitest_coverline("build/yui-core/yui-core.js", 231);
if (s.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 232);
r[i] = s[i];
                }
            }
        },
...
if (docEl && docClass.indexOf(DOC_LABEL) == -1) {
    _yuitest_coverline("build/yui-core/yui-core.js", 242);
if (docClass) {
        _yuitest_coverline("build/yui-core/yui-core.js", 243);
docClass += ' ';
    }
    _yuitest_coverline("build/yui-core/yui-core.js", 245);
docClass += DOC_LABEL;
    _yuitest_coverline("build/yui-core/yui-core.js", 246);
docEl.className = docClass;
}

_yuitest_coverline("build/yui-core/yui-core.js", 249);
if (VERSION.indexOf('@') > -1) {
    _yuitest_coverline("build/yui-core/yui-core.js", 250);
VERSION = '3.5.0'; // dev time hack for cdn test
}

_yuitest_coverline("build/yui-core/yui-core.js", 253);
proto = {
    /**
    ...
    **/
    applyConfig: function(o) {
        ...
        _yuitest_coverfunc("build/yui-core/yui-core.js", "applyConfig", 263);
_yuitest_coverline("build/yui-core/yui-core.js", 265);
o = o || NOOP;

        _yuitest_coverline("build/yui-core/yui-core.js", 267);
var attr,
            name,
            // detail,
            config = this.config,
...
attr = o[name];
                _yuitest_coverline("build/yui-core/yui-core.js", 279);
...
clobber(groups, attr);
                } else {_yuitest_coverline("build/yui-core/yui-core.js", 285);
if (name == 'win') {
                    _yuitest_coverline("build/yui-core/yui-core.js", 286);
config[name] = (attr && attr.contentWindow) || attr;
                    _yuitest_coverline("build/yui-core/yui-core.js", 287);
config.doc = config[name] ? config[name].document : null;
                } else {_yuitest_coverline("build/yui-core/yui-core.js", 288);
if (name == '_yuid') {
                    // preserve the guid
                } else {
                    _yuitest_coverline("build/yui-core/yui-core.js", 291);
config[name] = attr;
                }}}}}
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 296);
if (loader) {
            _yuitest_coverline("build/yui-core/yui-core.js", 297);
loader._config(o);
        }
    ...
    **/
    _config: function(o) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_config", 310);
_yuitest_coverline("build/yui-core/yui-core.js", 311);
this.applyConfig(o);
    },
    ...
    **/
    _init: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_init", 320);
_yuitest_coverline("build/yui-core/yui-core.js", 321);
var filter, el,
            Y = this,
            G_ENV = YUI.Env,
            Env = Y.Env,
        ...
        **/
        _yuitest_coverline("build/yui-core/yui-core.js", 336);
Y.version = VERSION;

        _yuitest_coverline("build/yui-core/yui-core.js", 338);
if (!Env) {
            _yuitest_coverline("build/yui-core/yui-core.js", 339);
Y.Env = {
                core: ['intl-base'],
                ...
                parseBasePath: function(src, pattern) {
                    _yuitest_coverfunc("build/yui-core/yui-core.js", "parseBasePath", 384);
_yuitest_coverline("build/yui-core/yui-core.js", 385);
var match = src.match(pattern),
                        path, filter;

                    _yuitest_coverline("build/yui-core/yui-core.js", 388);
if (match) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 389);
path = RegExp.leftContext || src.slice(0, src.indexOf(match[0]));

                        // this is to set up the path to the loader.  The file
                        // filter for loader should match the yui include.
                        _yuitest_coverline("build/yui-core/yui-core.js", 393);
filter = match[3];

                        // extract correct path for mixed combo urls
                        // http://yuilibrary.com/projects/yui3/ticket/2528423
                        _yuitest_coverline("build/yui-core/yui-core.js", 397);
if (match[1]) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 398);
path += '?' + match[1];
                        }
                        _yuitest_coverline("build/yui-core/yui-core.js", 400);
path = {
                            filter: filter,
                            path: path
                        };
...
return path;
                ...
                getBase: G_ENV && G_ENV.getBase ||
                        function(pattern) {
                            _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 2)", 408);
_yuitest_coverline("build/yui-core/yui-core.js", 409);
var nodes = (doc && doc.getElementsByTagName('script')) || [],
                                path = Env.cdn, parsed,
                                i, len, src;

                            _yuitest_coverline("build/yui-core/yui-core.js", 413);
for (i = 0, len = nodes.length; i < len; ++i) {
                                _yuitest_coverline("build/yui-core/yui-core.js", 414);
src = nodes[i].src;
                                _yuitest_coverline("build/yui-core/yui-core.js", 415);
if (src) {
                                    _yuitest_coverline("build/yui-core/yui-core.js", 416);
parsed = Y.Env.parseBasePath(src, pattern);
                                    _yuitest_coverline("build/yui-core/yui-core.js", 417);
if (parsed) {
                                        _yuitest_coverline("build/yui-core/yui-core.js", 418);
filter = parsed.filter;
                                        _yuitest_coverline("build/yui-core/yui-core.js", 419);
path = parsed.path;
                                        _yuitest_coverline("build/yui-core/yui-core.js", 420);
break;
                                    }
                                }
                            }
...
Env._guidp = ('yui_' + VERSION + '_' +
            ...
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 439);
if (YUI._YUI) {

                _yuitest_coverline("build/yui-core/yui-core.js", 441);
G_ENV = YUI._YUI.Env;
                _yuitest_coverline("build/yui-core/yui-core.js", 442);
Env._yidx += G_ENV._yidx;
                _yuitest_coverline("build/yui-core/yui-core.js", 443);
Env._uidx += G_ENV._uidx;

                _yuitest_coverline("build/yui-core/yui-core.js", 445);
for (prop in G_ENV) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 446);
if (!(prop in Env)) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 447);
Env[prop] = G_ENV[prop];
                    }
                }

                _yuitest_coverline("build/yui-core/yui-core.js", 451);
delete YUI._YUI;
            }}

            _yuitest_coverline("build/yui-core/yui-core.js", 454);
Y.id = Y.stamp(Y);
            _yuitest_coverline("build/yui-core/yui-core.js", 455);
instances[Y.id] = Y;

        }

        _yuitest_coverline("build/yui-core/yui-core.js", 459);
Y.constructor = YUI;

        // configuration defaults
        _yuitest_coverline("build/yui-core/yui-core.js", 462);
Y.config = Y.config || {
            bootstrap: true,
            cacheUse: true,
            debug: true,
...
docEl.insertBefore(YUI.Env.cssStampEl, docEl.firstChild);
        ...
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 485);
if (doc && doc.getElementById(CSS_STAMP_EL) && !YUI.Env.cssStampEl) {
            _yuitest_coverline("build/yui-core/yui-core.js", 486);
YUI.Env.cssStampEl = doc.getElementById(CSS_STAMP_EL);
        }}

        _yuitest_coverline("build/yui-core/yui-core.js", 489);
Y.config.lang = Y.config.lang || 'en-US';

        _yuitest_coverline("build/yui-core/yui-core.js", 491);
Y.config.base = YUI.config.base || Y.Env.getBase(Y.Env._BASE_RE);

        _yuitest_coverline("build/yui-core/yui-core.js", 493);
if (!filter || (!('mindebug').indexOf(filter))) {
            _yuitest_coverline("build/yui-core/yui-core.js", 494);
filter = 'min';
        }
        _yuitest_coverline("build/yui-core/yui-core.js", 496);
filter = (filter) ? '-' + filter : filter;
        _yuitest_coverline("build/yui-core/yui-core.js", 497);
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
    ...
    **/
    _setup: function(o) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_setup", 508);
...
var i, Y = this,
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 514);
for (i = 0; i < extras.length; i++) {
            _yuitest_coverline("build/yui-core/yui-core.js", 515);
if (mods[extras[i]]) {
                _yuitest_coverline("build/yui-core/yui-core.js", 516);
core.push(extras[i]);
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 520);
Y._attach(['yui-base']);
        _yuitest_coverline("build/yui-core/yui-core.js", 521);
Y._attach(core);

        _yuitest_coverline("build/yui-core/yui-core.js", 523);
if (Y.Loader) {
            _yuitest_coverline("build/yui-core/yui-core.js", 524);
getLoader(Y);
        }
    ...
    **/
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "applyTo", 541);
_yuitest_coverline("build/yui-core/yui-core.js", 542);
if (!(method in APPLY_TO_AUTH)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 543);
this.log(method + ': applyTo not allowed', 'warn', 'yui');
            _yuitest_coverline("build/yui-core/yui-core.js", 544);
return null;
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 547);
var instance = instances[id], nest, m, i;
        _yuitest_coverline("build/yui-core/yui-core.js", 548);
if (instance) {
            _yuitest_coverline("build/yui-core/yui-core.js", 549);
nest = method.split('.');
            _yuitest_coverline("build/yui-core/yui-core.js", 550);
m = instance;
            _yuitest_coverline("build/yui-core/yui-core.js", 551);
for (i = 0; i < nest.length; i = i + 1) {
                _yuitest_coverline("build/yui-core/yui-core.js", 552);
m = m[nest[i]];
                _yuitest_coverline("build/yui-core/yui-core.js", 553);
if (!m) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 554);
this.log('applyTo not found: ' + method, 'warn', 'yui');
                }
            }
            _yuitest_coverline("build/yui-core/yui-core.js", 557);
return m && m.apply(instance, args);
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 560);
return null;
    },
...
**/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "add", 610);
_yuitest_coverline("build/yui-core/yui-core.js", 611);
details = details || {};
        _yuitest_coverline("build/yui-core/yui-core.js", 612);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 624);
env.mods[name] = mod;
        _yuitest_coverline("build/yui-core/yui-core.js", 625);
versions[version] = versions[version] || {};
        _yuitest_coverline("build/yui-core/yui-core.js", 626);
versions[version][name] = mod;

        _yuitest_coverline("build/yui-core/yui-core.js", 628);
for (i in instances) {
            _yuitest_coverline("build/yui-core/yui-core.js", 629);
if (instances.hasOwnProperty(i)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 630);
inst = instances[i];
                _yuitest_coverline("build/yui-core/yui-core.js", 631);
if (!applied[inst.id]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 632);
applied[inst.id] = true;
                    _yuitest_coverline("build/yui-core/yui-core.js", 633);
loader = inst.Env._loader;
                    _yuitest_coverline("build/yui-core/yui-core.js", 634);
if (loader) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 635);
if (!loader.moduleInfo[name] || loader.moduleInfo[name].temp) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 636);
...
return this;
    ...
    **/
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_attach", 656);
...
mod = mods[name];
            _yuitest_coverline("build/yui-core/yui-core.js", 672);
c.push(name);
            _yuitest_coverline("build/yui-core/yui-core.js", 673);
if (loader && loader.conditions[name]) {
                _yuitest_coverline("build/yui-core/yui-core.js", 674);
for (j in loader.conditions[name]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 675);
...
r = c;
        _yuitest_coverline("build/yui-core/yui-core.js", 686);
len = r.length;
...
mod = mods[name];
                ...
                _yuitest_coverline("build/yui-core/yui-core.js", 693);
if (aliases && aliases[name] && !mod) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 694);
Y._attach(aliases[name]);
                    _yuitest_coverline("build/yui-core/yui-core.js", 695);
continue;
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 697);
if (!mod) {
...
if ((name.indexOf('skin-') === -1) && (name.indexOf('css') === -1)) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 708);
...
for (j = 0; j < Y.Env._missed.length; j++) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 718);
...
Y.Env._missed.splice(j, 1);
                    ...
                    */
                    _yuitest_coverline("build/yui-core/yui-core.js", 728);
if (loader && cache && cache[name] && cache[name].temp) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 729);
...
Y._attach(req);
                    ...
                    _yuitest_coverline("build/yui-core/yui-core.js", 739);
details = mod.details;
                    _yuitest_coverline("build/yui-core/yui-core.js", 740);
...
for (j = 0; j < req.length; j++) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 751);
if (!done[req[j]]) {
                                _yuitest_coverline("build/yui-core/yui-core.js", 752);
if (!Y._attach(req)) {
                                    _yuitest_coverline("build/yui-core/yui-core.js", 753);
return false;
                                }
...
for (j = 0; j < after.length; j++) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 762);
if (!done[after[j]]) {
                                _yuitest_coverline("build/yui-core/yui-core.js", 763);
if (!Y._attach(after, true)) {
                                    _yuitest_coverline("build/yui-core/yui-core.js", 764);
return false;
                                }
                                _yuitest_coverline("build/yui-core/yui-core.js", 766);
break;
                            }
                        }
                    }
...
if (Y.config.throwFail) {
                                _yuitest_coverline("build/yui-core/yui-core.js", 773);
mod.fn(Y, name);
                            } else {
                                _yuitest_coverline("build/yui-core/yui-core.js", 775);
try {
                                    _yuitest_coverline("build/yui-core/yui-core.js", 776);
mod.fn(Y, name);
                                } catch (e) {
                                    _yuitest_coverline("build/yui-core/yui-core.js", 778);
Y.error('Attach error: ' + name, e, name);
                                _yuitest_coverline("build/yui-core/yui-core.js", 779);
return false;
                            }
                        }
                    }

                    _yuitest_coverline("build/yui-core/yui-core.js", 784);
if (use) {
...
return false;
                                ...
                                _yuitest_coverline("build/yui-core/yui-core.js", 790);
break;
                            }
                        }
                    }
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 801);
return true;
    },
    ...
    **/
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_delayCallback", 815);
_yuitest_coverline("build/yui-core/yui-core.js", 817);
var Y = this,
            mod = ['event-base'];

        _yuitest_coverline("build/yui-core/yui-core.js", 820);
until = (Y.Lang.isObject(until) ? until : { event: until });

        _yuitest_coverline("build/yui-core/yui-core.js", 822);
if (until.event === 'load') {
            _yuitest_coverline("build/yui-core/yui-core.js", 823);
mod.push('event-synthetic');
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 826);
return function() {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 3)", 826);
_yuitest_coverline("build/yui-core/yui-core.js", 827);
var args = arguments;
            _yuitest_coverline("build/yui-core/yui-core.js", 828);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 4)", 828);
_yuitest_coverline("build/yui-core/yui-core.js", 829);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 5)", 829);
_yuitest_coverline("build/yui-core/yui-core.js", 830);
args[1].delayUntil = until.event;
                    _yuitest_coverline("build/yui-core/yui-core.js", 831);
cb.apply(Y, args);
                }, until.args);
            });
        };
    ...
    **/
    use: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "use", 900);
_yuitest_coverline("build/yui-core/yui-core.js", 901);
...
if (Y.config.cacheUse) {
            _yuitest_coverline("build/yui-core/yui-core.js", 924);
while ((name = args[i++])) {
                _yuitest_coverline("build/yui-core/yui-core.js", 925);
if (!Env._attached[name]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 926);
provisioned = false;
                    _yuitest_coverline("build/yui-core/yui-core.js", 927);
break;
                }
            }

            _yuitest_coverline("build/yui-core/yui-core.js", 931);
if (provisioned) {
                _yuitest_coverline("build/yui-core/yui-core.js", 932);
if (args.length) {
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 934);
Y._notify(callback, ALREADY_DONE, args);
                _yuitest_coverline("build/yui-core/yui-core.js", 935);
return Y;
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 939);
if (Y._loading) {
...
Y._useQueue.add([args, callback]);
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 943);
Y._use(args, function(Y, response) {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 6)", 943);
_yuitest_coverline("build/yui-core/yui-core.js", 944);
Y._notify(callback, response, args);
            });
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 948);
return Y;
    },
    ...
    **/
    _notify: function(callback, response, args) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_notify", 960);
_yuitest_coverline("build/yui-core/yui-core.js", 961);
if (!response.success && this.config.loadErrorFn) {
            _yuitest_coverline("build/yui-core/yui-core.js", 962);
this.config.loadErrorFn.call(this, this, callback, response, args);
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 963);
if (callback) {
...
response.success = false;
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 968);
...
this.error('use callback error', e, args);
    ...
    **/
    _use: function(args, callback) {
        ...
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_use", 990);
_yuitest_coverline("build/yui-core/yui-core.js", 992);
if (!this.Array) {
            _yuitest_coverline("build/yui-core/yui-core.js", 993);
...
var len, loader, handleBoot, handleRLS,
            ...
            process = function(names, skip) {
                ...
                _yuitest_coverfunc("build/yui-core/yui-core.js", "process", 1013);
_yuitest_coverline("build/yui-core/yui-core.js", 1015);
var i = 0, a = [], name, len, m, req, use;

                _yuitest_coverline("build/yui-core/yui-core.js", 1017);
if (!names.length) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1018);
return;
                }

                _yuitest_coverline("build/yui-core/yui-core.js", 1021);
if (aliases) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1022);
len = names.length;
                    _yuitest_coverline("build/yui-core/yui-core.js", 1023);
for (i = 0; i < len; i++) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 1024);
if (aliases[names[i]] && !mods[names[i]]) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 1025);
...
a.push(names[i]);
                    ...
                    _yuitest_coverline("build/yui-core/yui-core.js", 1030);
names = a;
                }

                _yuitest_coverline("build/yui-core/yui-core.js", 1033);
len = names.length;
...
m = mods[name];
                    _yuitest_coverline("build/yui-core/yui-core.js", 1047);
req = null;
                    _yuitest_coverline("build/yui-core/yui-core.js", 1048);
use = null;
...
use = m.details.use;
                        ...
                        // been loaded
                        _yuitest_coverline("build/yui-core/yui-core.js", 1057);
...
used[name] = true; // probably css
                    ...
                    _yuitest_coverline("build/yui-core/yui-core.js", 1065);
if (req && req.length) {
...
process(req);
                    ...
                    _yuitest_coverline("build/yui-core/yui-core.js", 1070);
if (use && use.length) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 1071);
process(use, 1);
                    }
                }
            ...
            handleLoader = function(fromLoader) {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "handleLoader", 1077);
...
missing = [];
                    _yuitest_coverline("build/yui-core/yui-core.js", 1091);
r = [];
                    _yuitest_coverline("build/yui-core/yui-core.js", 1092);
process(data);
                    _yuitest_coverline("build/yui-core/yui-core.js", 1093);
redo = missing.length;
                    _yuitest_coverline("build/yui-core/yui-core.js", 1094);
if (redo) {
...
Y._loading = true;
                    _yuitest_coverline("build/yui-core/yui-core.js", 1104);
Y._use(missing, function() {
                        _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 7)", 1104);
...
if (ret) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 1114);
Y._notify(callback, response, args);
                    }
                }
...
if (firstArg === '*') {
            _yuitest_coverline("build/yui-core/yui-core.js", 1127);
args = [];
            _yuitest_coverline("build/yui-core/yui-core.js", 1128);
for (i in mods) {
...
return Y;
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 1140);
...
Y._attach(['loader' + ((!mods.loader) ? '-base' : '')]);
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 1147);
if (boot && Y.Loader && args.length) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1148);
loader = getLoader(Y);
            _yuitest_coverline("build/yui-core/yui-core.js", 1149);
loader.require(args);
            _yuitest_coverline("build/yui-core/yui-core.js", 1150);
...
process(args);
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 1159);
len = missing.length;


        _yuitest_coverline("build/yui-core/yui-core.js", 1162);
if (len) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1163);
missing = YArray.dedupe(missing);
            _yuitest_coverline("build/yui-core/yui-core.js", 1164);
len = missing.length;
        }


        // dynamic load
        _yuitest_coverline("build/yui-core/yui-core.js", 1169);
if (boot && len && Y.Loader) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1170);
Y._loading = true;
            _yuitest_coverline("build/yui-core/yui-core.js", 1171);
loader = getLoader(Y);
            _yuitest_coverline("build/yui-core/yui-core.js", 1172);
loader.onEnd = handleLoader;
            _yuitest_coverline("build/yui-core/yui-core.js", 1173);
loader.context = Y;
            _yuitest_coverline("build/yui-core/yui-core.js", 1174);
loader.data = args;
            _yuitest_coverline("build/yui-core/yui-core.js", 1175);
loader.ignoreRegistered = false;
            _yuitest_coverline("build/yui-core/yui-core.js", 1176);
loader.require(missing);
            _yuitest_coverline("build/yui-core/yui-core.js", 1177);
loader.insert(null, (fetchCSS) ? null : 'js');

        } else {_yuitest_coverline("build/yui-core/yui-core.js", 1179);
if (boot && len && Y.Get && !Env.bootstrapped) {

            _yuitest_coverline("build/yui-core/yui-core.js", 1181);
Y._loading = true;

            _yuitest_coverline("build/yui-core/yui-core.js", 1183);
handleBoot = function() {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "handleBoot", 1183);
_yuitest_coverline("build/yui-core/yui-core.js", 1184);
Y._loading = false;
                _yuitest_coverline("build/yui-core/yui-core.js", 1185);
queue.running = false;
                _yuitest_coverline("build/yui-core/yui-core.js", 1186);
Env.bootstrapped = true;
                _yuitest_coverline("build/yui-core/yui-core.js", 1187);
G_ENV._bootstrapping = false;
                _yuitest_coverline("build/yui-core/yui-core.js", 1188);
if (Y._attach(['loader'])) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1189);
Y._use(args, callback);
                }
            };

            _yuitest_coverline("build/yui-core/yui-core.js", 1193);
if (G_ENV._bootstrapping) {
                _yuitest_coverline("build/yui-core/yui-core.js", 1194);
...
return Y;
    ...
    **/
    namespace: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "namespace", 1252);
_yuitest_coverline("build/yui-core/yui-core.js", 1253);
var a = arguments, o, i = 0, j, d, arg;

        _yuitest_coverline("build/yui-core/yui-core.js", 1255);
for (; i < a.length; i++) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1256);
o = this; //Reset base object per argument or it will get reused from the last
            _yuitest_coverline("build/yui-core/yui-core.js", 1257);
arg = a[i];
...
for (j = (d[0] == 'YAHOO') ? 1 : 0; j < d.length; j++) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1261);
o[d[j]] = o[d[j]] || {};
                    _yuitest_coverline("build/yui-core/yui-core.js", 1262);
o = o[d[j]];
                }
            } else {
                _yuitest_coverline("build/yui-core/yui-core.js", 1265);
o[arg] = o[arg] || {};
                _yuitest_coverline("build/yui-core/yui-core.js", 1266);
o = o[arg]; //Reset base object to the new object so it's returned
            }
        }
        _yuitest_coverline("build/yui-core/yui-core.js", 1269);
return o;
    },
    ...
    dump: function (o) { _yuitest_coverfunc("build/yui-core/yui-core.js", "dump", 1276);
...
return ''+o; },
    ...
    **/
    error: function(msg, e, src) {
        ...
        _yuitest_coverfunc("build/yui-core/yui-core.js", "error", 1295);
_yuitest_coverline("build/yui-core/yui-core.js", 1298);
var Y = this, ret;

        _yuitest_coverline("build/yui-core/yui-core.js", 1300);
if (Y.config.errorFn) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1301);
ret = Y.config.errorFn.apply(Y, arguments);
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 1304);
if (!ret) {
...
return Y;
    ...
    **/
    guid: function(pre) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "guid", 1321);
_yuitest_coverline("build/yui-core/yui-core.js", 1322);
var id = this.Env._guidp + '_' + (++this.Env._uidx);
        _yuitest_coverline("build/yui-core/yui-core.js", 1323);
return (pre) ? (pre + id) : id;
    ...
    **/
    stamp: function(o, readOnly) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "stamp", 1343);
_yuitest_coverline("build/yui-core/yui-core.js", 1344);
var uid;
        _yuitest_coverline("build/yui-core/yui-core.js", 1345);
if (!o) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1346);
return o;
        }

        // IE generates its own unique ID for dom nodes
        // The uniqueID property of a document node returns a new ID
        _yuitest_coverline("build/yui-core/yui-core.js", 1351);
if (o.uniqueID && o.nodeType && o.nodeType !== 9) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1352);
uid = o.uniqueID;
        } else {
            _yuitest_coverline("build/yui-core/yui-core.js", 1354);
uid = (typeof o === 'string') ? o : o._yuid;
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 1357);
if (!uid) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1358);
uid = this.guid();
            _yuitest_coverline("build/yui-core/yui-core.js", 1359);
if (!readOnly) {
                _yuitest_coverline("build/yui-core/yui-core.js", 1360);
try {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1361);
o._yuid = uid;
                } catch (e) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 1363);
uid = null;
                }
            }
        }
...
return uid;
    ...
    **/
    destroy: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "destroy", 1376);
_yuitest_coverline("build/yui-core/yui-core.js", 1377);
var Y = this;
        _yuitest_coverline("build/yui-core/yui-core.js", 1378);
if (Y.Event) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1379);
Y.Event._unload();
        }
...
delete Y.config;
    ...
    **/
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 1400);
YUI.prototype = proto;

    // inheritance utilities are not available yet
    _yuitest_coverline("build/yui-core/yui-core.js", 1403);
for (prop in proto) {
        _yuitest_coverline("build/yui-core/yui-core.js", 1404);
if (proto.hasOwnProperty(prop)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1405);
YUI[prop] = proto[prop];
        }
    }
    ...
    @since 3.5.0
    **/
    _yuitest_coverline("build/yui-core/yui-core.js", 1444);
YUI.applyConfig = function(o) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "applyConfig", 1444);
_yuitest_coverline("build/yui-core/yui-core.js", 1445);
if (!o) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1446);
return;
        }
        //If there is a GlobalConfig, apply it first to set the defaults
        _yuitest_coverline("build/yui-core/yui-core.js", 1449);
if (YUI.GlobalConfig) {
            _yuitest_coverline("build/yui-core/yui-core.js", 1450);
this.prototype.applyConfig.call(this, YUI.GlobalConfig);
        }
        //Apply this config to it
        _yuitest_coverline("build/yui-core/yui-core.js", 1453);
this.prototype.applyConfig.call(this, o);
        //Reset GlobalConfig to the combined config
        _yuitest_coverline("build/yui-core/yui-core.js", 1455);
YUI.GlobalConfig = this.config;
    };

    // set up the environment
    _yuitest_coverline("build/yui-core/yui-core.js", 1459);
YUI._init();

    _yuitest_coverline("build/yui-core/yui-core.js", 1461);
if (hasWin) {
        // add a window load event at load time so we can capture
        // the case where it fires before dynamic loading is
        // complete.
        _yuitest_coverline("build/yui-core/yui-core.js", 1465);
add(window, 'load', handleLoad);
    } else {
        _yuitest_coverline("build/yui-core/yui-core.js", 1467);
handleLoad();
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 1470);
YUI.Env.add = add;
    _yuitest_coverline("build/yui-core/yui-core.js", 1471);
YUI.Env.remove = remove;

    /*global exports*/
    // Support the CommonJS method for exporting our single global
    _yuitest_coverline("build/yui-core/yui-core.js", 1475);
if (typeof exports == 'object') {
        _yuitest_coverline("build/yui-core/yui-core.js", 1476);
exports.YUI = YUI;
    }
...
@since 3.6.0
**/
_yuitest_coverline("build/yui-core/yui-core.js", 1711);
...
_yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 8)", 1711);
_yuitest_coverline("build/yui-core/yui-core.js", 1733);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui-core/yui-core.js", 1781);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "_isNative", 1781);
_yuitest_coverline("build/yui-core/yui-core.js", 1782);
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1799);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isArray", 1799);
_yuitest_coverline("build/yui-core/yui-core.js", 1800);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1810);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isBoolean", 1810);
_yuitest_coverline("build/yui-core/yui-core.js", 1811);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1821);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isDate", 1821);
_yuitest_coverline("build/yui-core/yui-core.js", 1822);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1849);
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isFunction", 1849);
_yuitest_coverline("build/yui-core/yui-core.js", 1850);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1860);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isNull", 1860);
_yuitest_coverline("build/yui-core/yui-core.js", 1861);
return o === null;
};
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1871);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isNumber", 1871);
_yuitest_coverline("build/yui-core/yui-core.js", 1872);
 ...
 * @see isPlainObject
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1886);
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isObject", 1886);
_yuitest_coverline("build/yui-core/yui-core.js", 1887);
var t = typeof o;
    _yuitest_coverline("build/yui-core/yui-core.js", 1888);
return (o && (t === 'object' ||
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1899);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isString", 1899);
_yuitest_coverline("build/yui-core/yui-core.js", 1900);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1910);
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isUndefined", 1910);
_yuitest_coverline("build/yui-core/yui-core.js", 1911);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1923);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isValue", 1923);
_yuitest_coverline("build/yui-core/yui-core.js", 1924);
var t = L.type(o);

    _yuitest_coverline("build/yui-core/yui-core.js", 1926);
switch (t) {
        case 'number':
            _yuitest_coverline("build/yui-core/yui-core.js", 1928);
return isFinite(o);

        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("build/yui-core/yui-core.js", 1932);
return false;

        default:
            _yuitest_coverline("build/yui-core/yui-core.js", 1935);
return !!t;
    }
};
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1947);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 9)", 1947);
_yuitest_coverline("build/yui-core/yui-core.js", 1948);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1962);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "sub", 1962);
_yuitest_coverline("build/yui-core/yui-core.js", 1963);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 10)", 1963);
_yuitest_coverline("build/yui-core/yui-core.js", 1964);
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1976);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 11)", 1976);
_yuitest_coverline("build/yui-core/yui-core.js", 1977);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 1978);
_yuitest_coverline("build/yui-core/yui-core.js", 1979);
try {
        _yuitest_coverline("build/yui-core/yui-core.js", 1980);
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-core/yui-core.js", 1993);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 12)", 1993);
_yuitest_coverline("build/yui-core/yui-core.js", 1994);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 1995);
_yuitest_coverline("build/yui-core/yui-core.js", 1996);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-core/yui-core.js", 2006);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 13)", 2006);
_yuitest_coverline("build/yui-core/yui-core.js", 2007);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 2008);
_yuitest_coverline("build/yui-core/yui-core.js", 2009);
return s.replace(/\s+$/, '');
};
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "type", 2039);
_yuitest_coverline("build/yui-core/yui-core.js", 2040);
...
_yuitest_coverline("build/yui-core/yui-core.js", 2047);
var Lang   = Y.Lang,
...
@return {Array} A native array created from _thing_, according to the rules
  described above.
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2080);
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "YArray", 2080);
_yuitest_coverline("build/yui-core/yui-core.js", 2081);
var len, result;

    _yuitest_coverline("build/yui-core/yui-core.js", 2083);
startIndex || (startIndex = 0);

    _yuitest_coverline("build/yui-core/yui-core.js", 2085);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("build/yui-core/yui-core.js", 2087);
try {
            _yuitest_coverline("build/yui-core/yui-core.js", 2088);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2090);
result = [];

            _yuitest_coverline("build/yui-core/yui-core.js", 2092);
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2093);
result.push(thing[startIndex]);
            }

            _yuitest_coverline("build/yui-core/yui-core.js", 2096);
return result;
        }
    }
...
_yuitest_coverline("build/yui-core/yui-core.js", 2103);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2119);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "dedupe", 2119);
_yuitest_coverline("build/yui-core/yui-core.js", 2120);
var hash    = {},
        results = [],
        i, item, len;

    _yuitest_coverline("build/yui-core/yui-core.js", 2124);
...
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2128);
hash[item] = 1;
            _yuitest_coverline("build/yui-core/yui-core.js", 2129);
results.push(item);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2133);
return results;
};
...
@static
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2151);
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 14)", 2151);
_yuitest_coverline("build/yui-core/yui-core.js", 2152);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui-core/yui-core.js", 2153);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 2154);
_yuitest_coverline("build/yui-core/yui-core.js", 2155);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2156);
if (i in array) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2157);
fn.call(thisObj || Y, array[i], i, array);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2161);
return Y;
};
...
@static
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2188);
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "hash", 2188);
_yuitest_coverline("build/yui-core/yui-core.js", 2189);
var hash = {},
        vlen = (values && values.length) || 0,
        i, len;

    _yuitest_coverline("build/yui-core/yui-core.js", 2193);
for (i = 0, len = keys.length; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2194);
if (i in keys) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2195);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2199);
return hash;
};
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 15)", 2216);
_yuitest_coverline("build/yui-core/yui-core.js", 2217);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 2218);
_yuitest_coverline("build/yui-core/yui-core.js", 2220);
var len = array.length;

    _yuitest_coverline("build/yui-core/yui-core.js", 2222);
from = +from || 0;
    _yuitest_coverline("build/yui-core/yui-core.js", 2223);
...
for (; from < len; ++from) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2234);
...
return from;
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2239);
return -1;
};
...
@static
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2261);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "numericSort", 2261);
_yuitest_coverline("build/yui-core/yui-core.js", 2262);
return a - b;
};
...
@static
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2281);
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 16)", 2281);
_yuitest_coverline("build/yui-core/yui-core.js", 2282);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "}", 2283);
_yuitest_coverline("build/yui-core/yui-core.js", 2284);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2285);
...
return true;
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2290);
return false;
};
...
@static
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2311);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "test", 2311);
_yuitest_coverline("build/yui-core/yui-core.js", 2312);
var result = 0;

    _yuitest_coverline("build/yui-core/yui-core.js", 2314);
if (Lang.isArray(obj)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2315);
result = 1;
    } else {_yuitest_coverline("build/yui-core/yui-core.js", 2316);
if (Lang.isObject(obj)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2317);
try {
            // indexed, but no tagName (element) or scrollTo/document (window. From DOM.isWindow test which we can't use here),
            // or functions without apply/call (Safari
            // HTMLElementCollection bug).
            _yuitest_coverline("build/yui-core/yui-core.js", 2321);
...
function Queue() {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "Queue", 2345);
_yuitest_coverline("build/yui-core/yui-core.js", 2346);
this._init();
    _yuitest_coverline("build/yui-core/yui-core.js", 2347);
this.add.apply(this, arguments);
}

_yuitest_coverline("build/yui-core/yui-core.js", 2350);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-core/yui-core.js", "_init", 2357);
_yuitest_coverline("build/yui-core/yui-core.js", 2365);
this._q = [];
    },
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "next", 2374);
_yuitest_coverline("build/yui-core/yui-core.js", 2375);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "last", 2384);
_yuitest_coverline("build/yui-core/yui-core.js", 2385);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "add", 2395);
_yuitest_coverline("build/yui-core/yui-core.js", 2396);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui-core/yui-core.js", 2398);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "size", 2407);
_yuitest_coverline("build/yui-core/yui-core.js", 2408);
return this._q.length;
    }
};

_yuitest_coverline("build/yui-core/yui-core.js", 2412);
Y.Queue = Queue;

_yuitest_coverline("build/yui-core/yui-core.js", 2414);
...
_yuitest_coverline("build/yui-core/yui-core.js", 2425);
...
@for YUI
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2454);
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "cached", 2454);
_yuitest_coverline("build/yui-core/yui-core.js", 2455);
cache || (cache = {});

    _yuitest_coverline("build/yui-core/yui-core.js", 2457);
return function (arg) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 17)", 2457);
_yuitest_coverline("build/yui-core/yui-core.js", 2458);
...
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2463);
...
@since 3.5.0
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2486);
Y.getLocation = function () {
    // It is safer to look this up every time because yui-base is attached to a
    // YUI instance before a user's config is applied; i.e. `Y.config.win` does
    // not point the correct window object when this file is loaded.
    _yuitest_coverfunc("build/yui-core/yui-core.js", "getLocation", 2486);
_yuitest_coverline("build/yui-core/yui-core.js", 2490);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2496);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "merge", 2511);
_yuitest_coverline("build/yui-core/yui-core.js", 2512);
var i      = 0,
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2518);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2519);
obj = arguments[i];

        _yuitest_coverline("build/yui-core/yui-core.js", 2521);
for (key in obj) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2522);
...
result[key] = obj[key];
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2528);
return result;
};
...
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2565);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "mix", 2565);
...
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2572);
return receiver || Y;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2575);
if (mode) {
        // In mode 2 (prototype to prototype and object to object), we recurse
        // once to do the proto to proto mix. The object to object mix will be
        // handled later on.
        _yuitest_coverline("build/yui-core/yui-core.js", 2579);
if (mode === 2) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2580);
...
from = mode === 1 || mode === 3 ? supplier.prototype : supplier;
        _yuitest_coverline("build/yui-core/yui-core.js", 2587);
to   = mode === 1 || mode === 4 ? receiver.prototype : receiver;

        // If either the supplier or receiver doesn't actually have a
        // prototype property, then we could end up with an undefined `from`
        // or `to`. If that happens, we abort and return the receiver.
        _yuitest_coverline("build/yui-core/yui-core.js", 2592);
if (!from || !to) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2593);
return receiver;
        }
    } else {
        _yuitest_coverline("build/yui-core/yui-core.js", 2596);
from = supplier;
        _yuitest_coverline("build/yui-core/yui-core.js", 2597);
to   = receiver;
    }

    // If `overwrite` is truthy and `merge` is falsy, then we can skip a
    // property existence check on each iteration and save some time.
    _yuitest_coverline("build/yui-core/yui-core.js", 2602);
alwaysOverwrite = overwrite && !merge;

    _yuitest_coverline("build/yui-core/yui-core.js", 2604);
if (whitelist) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2605);
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2606);
key = whitelist[i];
            ...
            // method.
            _yuitest_coverline("build/yui-core/yui-core.js", 2613);
...
continue;
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 2620);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("build/yui-core/yui-core.js", 2622);
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui-core/yui-core.js", 2632);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 2633);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 2641);
for (key in from) {
...
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2648);
continue;
            }
            ...
            // compatibility reasons. It prevents undesired shadowing of
            // prototype members on `to`.
            _yuitest_coverline("build/yui-core/yui-core.js", 2654);
exists = alwaysOverwrite ? false : key in to;

            _yuitest_coverline("build/yui-core/yui-core.js", 2656);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2658);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 2659);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2660);
to[key] = from[key];
            }}
        }
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui-core/yui-core.js", 2667);
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2668);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2672);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
_yuitest_coverline("build/yui-core/yui-core.js", 2688);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 18)", 2704);
_yuitest_coverline("build/yui-core/yui-core.js", 2710);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 19)", 2711);
_yuitest_coverline("build/yui-core/yui-core.js", 2713);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui-core/yui-core.js", 2716);
return function (obj) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 20)", 2716);
_yuitest_coverline("build/yui-core/yui-core.js", 2717);
F.prototype = obj;
        _yuitest_coverline("build/yui-core/yui-core.js", 2718);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "owns", 2779);
_yuitest_coverline("build/yui-core/yui-core.js", 2780);
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 2792);
O.hasKey = owns;
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "keys", 2815);
_yuitest_coverline("build/yui-core/yui-core.js", 2816);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2817);
...
var keys = [],
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2823);
...
keys.push(key);
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 2830);
for (key in obj) {
...
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2839);
key = forceEnum[i];
...
keys.push(key);
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2847);
return keys;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 2867);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "values", 2867);
_yuitest_coverline("build/yui-core/yui-core.js", 2868);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2874);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2877);
return values;
};
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "size", 2888);
_yuitest_coverline("build/yui-core/yui-core.js", 2889);
try {
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "hasValue", 2906);
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 2930);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "each", 2930);
_yuitest_coverline("build/yui-core/yui-core.js", 2931);
var key;

    _yuitest_coverline("build/yui-core/yui-core.js", 2933);
for (key in obj) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2934);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2935);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2939);
return Y;
};
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "some", 2962);
_yuitest_coverline("build/yui-core/yui-core.js", 2963);
var key;
...
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2968);
return true;
            }
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2973);
return false;
};
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 2989);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "getValue", 2989);
_yuitest_coverline("build/yui-core/yui-core.js", 2990);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2991);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2994);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui-core/yui-core.js", 2998);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2999);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3002);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "setValue", 3019);
_yuitest_coverline("build/yui-core/yui-core.js", 3020);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;

    _yuitest_coverline("build/yui-core/yui-core.js", 3025);
if (leafIdx >= 0) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3026);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3027);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3030);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3031);
ref[p[i]] = val;
        } else {
            _yuitest_coverline("build/yui-core/yui-core.js", 3033);
return UNDEFINED;
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3037);
return o;
};
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isEmpty", 3049);
_yuitest_coverline("build/yui-core/yui-core.js", 3050);
...
*/
_yuitest_coverline("build/yui-core/yui-core.js", 3085);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui-core/yui-core.js", "parseUA", 3085);
_yuitest_coverline("build/yui-core/yui-core.js", 3087);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "numberify", 3087);
_yuitest_coverline("build/yui-core/yui-core.js", 3088);
var c = 0;
            _yuitest_coverline("build/yui-core/yui-core.js", 3089);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 22)", 3089);
...
if (ua) {
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 3331);
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3332);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3333);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3334);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3335);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3336);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3337);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3338);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3339);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3340);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3341);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3342);
o.os = 'rhino';
        }}}}}}

        // Modern KHTML browsers should qualify as Safari X-Grade
        _yuitest_coverline("build/yui-core/yui-core.js", 3346);
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3347);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui-core/yui-core.js", 3349);
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3350);
o.mobile = 'windows';
        }
        _yuitest_coverline("build/yui-core/yui-core.js", 3352);
if ((/Fennec/).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3353);
o.mobile = 'gecko';
        }
        // Modern WebKit browsers are at least X-Grade
        _yuitest_coverline("build/yui-core/yui-core.js", 3356);
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui-core/yui-core.js", 3357);
if (m && m[1]) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3358);
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui-core/yui-core.js", 3359);
o.safari = o.webkit;

            _yuitest_coverline("build/yui-core/yui-core.js", 3361);
if (/PhantomJS/.test(ua)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 3362);
m = ua.match(/PhantomJS\/([^\s]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3363);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3364);
o.phantomjs = numberify(m[1]);
                }
            }

            // Mobile browser check
            _yuitest_coverline("build/yui-core/yui-core.js", 3369);
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 3370);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("build/yui-core/yui-core.js", 3372);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3373);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3374);
m = numberify(m[1].replace('_', '.'));
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3376);
o.ios = m;
                _yuitest_coverline("build/yui-core/yui-core.js", 3377);
o.os = 'ios';
                _yuitest_coverline("build/yui-core/yui-core.js", 3378);
o.ipad = o.ipod = o.iphone = 0;

                _yuitest_coverline("build/yui-core/yui-core.js", 3380);
m = ua.match(/iPad|iPod|iPhone/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3381);
if (m && m[0]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3382);
o[m[0].toLowerCase()] = o.ios;
                }
            } else {
                _yuitest_coverline("build/yui-core/yui-core.js", 3385);
m = ua.match(/NokiaN[^\/]*|webOS\/\d\.\d/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3386);
if (m) {
                    // Nokia N-series, webOS, ex: NokiaN95
                    _yuitest_coverline("build/yui-core/yui-core.js", 3388);
o.mobile = m[0];
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3390);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3391);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui-core/yui-core.js", 3392);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3393);
if (m && m[1]) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3394);
o.webos = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3397);
if (/ Android/.test(ua)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3398);
if (/Mobile/.test(ua)) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3399);
o.mobile = 'Android';
                    }
                    _yuitest_coverline("build/yui-core/yui-core.js", 3401);
m = ua.match(/Android ([^\s]*);/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3402);
if (m && m[1]) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3403);
o.android = numberify(m[1]);
                    }

                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3407);
if (/Silk/.test(ua)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3408);
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3409);
if (m && m[1]) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3410);
o.silk = numberify(m[1]);
                    }
                    _yuitest_coverline("build/yui-core/yui-core.js", 3412);
if (!o.android) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3413);
o.android = 2.34; //Hack for desktop mode in Kindle
                        _yuitest_coverline("build/yui-core/yui-core.js", 3414);
o.os = 'Android';
                    }
                    _yuitest_coverline("build/yui-core/yui-core.js", 3416);
if (/Accelerated=true/.test(ua)) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3417);
o.accel = true;
                    }
                }
            }

            _yuitest_coverline("build/yui-core/yui-core.js", 3422);
m = ua.match(/(Chrome|CrMo|CriOS)\/([^\s]*)/);
            _yuitest_coverline("build/yui-core/yui-core.js", 3423);
if (m && m[1] && m[2]) {
                _yuitest_coverline("build/yui-core/yui-core.js", 3424);
o.chrome = numberify(m[2]); // Chrome
                _yuitest_coverline("build/yui-core/yui-core.js", 3425);
o.safari = 0; //Reset safari back to 0
                _yuitest_coverline("build/yui-core/yui-core.js", 3426);
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3427);
o.mobile = 'chrome';
                }
            } else {
                _yuitest_coverline("build/yui-core/yui-core.js", 3430);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3431);
if (m) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3432);
o.air = m[0]; // Adobe AIR 1.0 or better
                }
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3437);
if (!o.webkit) { // not webkit
// @todo check Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1316; fi; U; ssr)
            _yuitest_coverline("build/yui-core/yui-core.js", 3439);
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 3440);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3441);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3442);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3444);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3445);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3446);
o.opera = numberify(m[1]); // opera 10+
                }

                _yuitest_coverline("build/yui-core/yui-core.js", 3449);
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3450);
o.mobile = 'opera';
                    _yuitest_coverline("build/yui-core/yui-core.js", 3451);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3452);
if (m && m[1]) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3453);
o.opera = numberify(m[1]);
                    }
                }
                _yuitest_coverline("build/yui-core/yui-core.js", 3456);
m = ua.match(/Opera Mini[^;]*/);

                _yuitest_coverline("build/yui-core/yui-core.js", 3458);
if (m) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3459);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui-core/yui-core.js", 3462);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui-core/yui-core.js", 3463);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3464);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui-core/yui-core.js", 3466);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3467);
if (m) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3468);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui-core/yui-core.js", 3469);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui-core/yui-core.js", 3470);
if (m && m[1]) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 3471);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 3481);
if (win && nav && !(o.chrome && o.chrome < 6)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3482);
o.touchEnabled = (("ontouchstart" in win) || (("msMaxTouchPoints" in nav) && (nav.msMaxTouchPoints > 0)));
    }

    //It was a parsed UA, do not assign the global value.
    _yuitest_coverline("build/yui-core/yui-core.js", 3486);
if (!subUA) {

        _yuitest_coverline("build/yui-core/yui-core.js", 3488);
if (typeof process === 'object') {

            _yuitest_coverline("build/yui-core/yui-core.js", 3490);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui-core/yui-core.js", 3492);
o.os = process.platform;
                _yuitest_coverline("build/yui-core/yui-core.js", 3493);
o.nodejs = numberify(process.versions.node);
            }
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3497);
YUI.Env.UA = o;

    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3501);
return o;
};


_yuitest_coverline("build/yui-core/yui-core.js", 3505);
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui-core/yui-core.js", 3527);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "compareVersions", 3527);
_yuitest_coverline("build/yui-core/yui-core.js", 3528);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui-core/yui-core.js", 3530);
if (a === b) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3531);
return 0;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3534);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui-core/yui-core.js", 3535);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui-core/yui-core.js", 3537);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3538);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui-core/yui-core.js", 3539);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui-core/yui-core.js", 3541);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui-core/yui-core.js", 3542);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui-core/yui-core.js", 3544);
if (aPart < bPart) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3545);
return -1;
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3548);
if (aPart > bPart) {
...
return 1;
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 3553);
return 0;
};
_yuitest_coverline("build/yui-core/yui-core.js", 3555);
YUI.Env.aliases = {
