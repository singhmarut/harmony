...
if (Y.QueryString && Y.QueryString.stringify) {
                _yuitest_coverline("build/io-base/io-base.js", 652);
config.data = data = Y.QueryString.stringify(data);
            } else {
            }
        }

        _yuitest_coverline("build/io-base/io-base.js", 657);
if (config.form) {
...
return io.upload(transaction, uri, config);
                ...
                _yuitest_coverline("build/io-base/io-base.js", 664);
data = io._serialize(config.form, data);
            }
        }

        _yuitest_coverline("build/io-base/io-base.js", 668);
if (data) {
            _yuitest_coverline("build/io-base/io-base.js", 669);
switch (method) {
                case 'GET':
                case 'HEAD':
                case 'DELETE':
...
u = io._concat(u, data);
                    _yuitest_coverline("build/io-base/io-base.js", 674);
data = '';
                    _yuitest_coverline("build/io-base/io-base.js", 675);
break;
                case 'POST':
                case 'PUT':
                    // If Content-Type is defined in the configuration object, or
...
config.headers = Y.merge({
                    ...
                    _yuitest_coverline("build/io-base/io-base.js", 684);
break;
            }
        }

        _yuitest_coverline("build/io-base/io-base.js", 688);
if (transaction.xdr) {
            // Route data to io-xdr module for flash and XDomainRequest.
            _yuitest_coverline("build/io-base/io-base.js", 690);
return io.xdr(u, transaction, config);
        }
        else {_yuitest_coverline("build/io-base/io-base.js", 692);
if (transaction.notify) {
...
return transaction.c.send(transaction, uri, config);
        ...
        _yuitest_coverline("build/io-base/io-base.js", 697);
if (!sync && !transaction.upload) {
            _yuitest_coverline("build/io-base/io-base.js", 698);
transaction.c.onreadystatechange = function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "onreadystatechange", 698);
...
transaction.c.open(method, u, !sync, config.username || null, config.password || null);
            _yuitest_coverline("build/io-base/io-base.js", 707);
io._setHeaders(transaction.c, config.headers || {});
            _yuitest_coverline("build/io-base/io-base.js", 708);
...
if (config.xdr && config.xdr.credentials && SUPPORTS_CORS) {
                _yuitest_coverline("build/io-base/io-base.js", 713);
...
transaction.c.send(data);
            ...
            _yuitest_coverline("build/io-base/io-base.js", 720);
if (sync) {
...
response.getAllResponseHeaders = function() {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getAllResponseHeaders", 728);
...
response.getResponseHeader = function(name) {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getResponseHeader", 732);
...
io.complete(transaction, config);
                _yuitest_coverline("build/io-base/io-base.js", 737);
io._result(transaction, config);
...
return response;
            ...
            _yuitest_coverline("build/io-base/io-base.js", 742);
if (transaction.xdr) {
...
return {
            id: transaction.id,
            abort: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "abort", 764);
_yuitest_coverline("build/io-base/io-base.js", 765);
return transaction.c ? io._abort(transaction, 'abort') : false;
            },
            isInProgress: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "isInProgress", 767);
_yuitest_coverline("build/io-base/io-base.js", 768);
...
Y.io = function(url, config) {
    ...
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "io", 880);
_yuitest_coverline("build/io-base/io-base.js", 883);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("build/io-base/io-base.js", 884);
...
Y.io.header = function(name, value) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "header", 898);
...
Y.io._map = {};
_yuitest_coverline("build/io-base/io-base.js", 908);
...
_yuitest_coverline("build/io-base/io-base.js", 917);
Y.mix(Y.IO, {
    /**
    ...
    */
    defaultTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "defaultTransport", 932);
_yuitest_coverline("build/io-base/io-base.js", 933);
if (id) {
            _yuitest_coverline("build/io-base/io-base.js", 934);
Y.IO._default = id;
        } else {
            _yuitest_coverline("build/io-base/io-base.js", 936);
var o = {
                c: Y.IO.transports[Y.IO._default](),
                notify: Y.IO._default === 'xhr' ? false : true
            };
            _yuitest_coverline("build/io-base/io-base.js", 940);
return o;
        }
    },
    /**
    ...
    */
    transports: {
        xhr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xhr", 950);
_yuitest_coverline("build/io-base/io-base.js", 951);
return XHR ? new XMLHttpRequest() :
                AX ? new ActiveXObject('Microsoft.XMLHTTP') : null;
        },
        xdr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xdr", 954);
_yuitest_coverline("build/io-base/io-base.js", 955);
return XDR ? new XDomainRequest() : null;
        },
        iframe: function () { _yuitest_coverfunc("build/io-base/io-base.js", "iframe", 957);
_yuitest_coverline("build/io-base/io-base.js", 957);
return {}; },
        flash: null,
        nodejs: null
    },
    ...
    */
    customTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "customTransport", 967);
_yuitest_coverline("build/io-base/io-base.js", 968);
var o = { c: Y.IO.transports[id]() };

        _yuitest_coverline("build/io-base/io-base.js", 970);
o[(id === 'xdr' || id === 'flash') ? 'xdr' : 'notify'] = true;
        _yuitest_coverline("build/io-base/io-base.js", 971);
return o;
    }
});
...
Y.mix(Y.IO.prototype, {
    ...
    */
    notify: function(event, transaction, config) {
        _yuitest_coverfunc("build/io-base/io-base.js", "notify", 984);
_yuitest_coverline("build/io-base/io-base.js", 985);
var io = this;
...
transaction.c = { status: 0, statusText: event };
                _yuitest_coverline("build/io-base/io-base.js", 992);
event = 'failure';
            default:
                _yuitest_coverline("build/io-base/io-base.js", 994);
